  ...
  if target-station != nobody  [
    ...
    ifelse distance target-station < 1 [
      ...
      ask target-station [
        ...
        ;; risking to drive for a better price, prospect theory
        ...
        if ([preference] of myself) = 0 and brand = 1 [
          if randomAspect < 75 [
            set refuelAtOtherStation true
          ]

        ]
        if ([preference] of myself) = 1 and brand = 0 [
          if subjectiveValue < -0.02 and randomAspect < 75  [
            set refuelAtOtherStation true
          ]
        ]
      ]
